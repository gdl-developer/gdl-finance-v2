...
import { CanaryInvestmentRequest } from './investment-request-canary.entity';

export enum FundRedemptionCanaryStatus {
...
@Entity()
export class FundRedemptionCanaryRequest {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @Column({
    type: 'varchar',
    length: 20,
    default: FundRedemptionCanaryStatus.PROCESSING,
  })
  status: FundRedemptionCanaryStatus;
