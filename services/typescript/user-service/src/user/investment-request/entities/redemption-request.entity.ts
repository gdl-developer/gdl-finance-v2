...
export enum FundRedemptionMMFStatus {
  PROCESSING = 'PROCESSING',
  COMPLETED = 'COMPLETED',
  FAILED = 'FAILED',
}

@Entity({ name: 'fund_redemption_mmf_requests' })
export class FundRedemptionMMFRequest {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @Column({
    type: 'varchar',
    length: 20,
    default: FundRedemptionMMFStatus.PROCESSING,
  })
